from sec_parsers.string_detectors import (
    AllCapsStringDetector,
    EmphasisCapStringDetector,
...
class HeaderStringDetectorGroup:
    def __init__(self):
        ...
        self.add_string_detector(
            EmptyStringDetector(parsing_rule="return", cleaning_rule="remove;")
        )
...
class SEC_10K_StringDetectorGroup(HeaderStringDetectorGroup):
    def __init__(self):
        ...
        new_detectors = [
            ...
            SignaturesStringDetector(
                parsing_rule="return", level=0, cleaning_rule="header;"
            ),
...
class SEC_DEF14A_StringDetectorGroup(HeaderStringDetectorGroup):
    def __init__(self):
        super().__init__()

        # Add part, item, and signatures detectors at the beginning
        new_detectors = [
            Schedule14ADetector(parsing_rule="return", cleaning_rule="header;"),
        ]
        self.insert_string_detectors(new_detectors)
